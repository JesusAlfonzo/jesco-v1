<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="departamento_id" class="form-control @error('departamento_id') is-invalid @enderror" value="{{ old('departamento_id', $solicitudCompra?->departamento_id) }}" id="departamento_id" placeholder="Departamento Id">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="usuario_id" class="form-control @error('usuario_id') is-invalid @enderror" value="{{ old('usuario_id', $solicitudCompra?->usuario_id) }}" id="usuario_id" placeholder="Usuario Id">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="estado" class="form-control @error('estado') is-invalid @enderror" value="{{ old('estado', $solicitudCompra?->estado) }}" id="estado" placeholder="Estado">
            {!! $errors->first('estado', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="observaciones" class="form-label">{{ __('Observaciones') }}</label>
            <input type="text" name="observaciones" class="form-control @error('observaciones') is-invalid @enderror" value="{{ old('observaciones', $solicitudCompra?->observaciones) }}" id="observaciones" placeholder="Observaciones">
