...
@section('template_title')
    <i class="bi bi-beaker me-2"></i> Crear Examen
@endsection
                ...
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-header d-flex justify-content-between align-items-center"
                        ...
                        <span class="card-title float d-flex align-items-center gap-2">
                            <i class="bi bi-beaker"></i> Crear Examen
                        </span>
                        <a href="{{ route('examenes.index') }}" class="btn btn-outline-light btn-sm d-flex align-items-center rounded-pill px-3">
                    ...
                    <div class="card-body bg-white p-4 rounded-bottom-4">
                        <form method="POST" action="{{ route('examenes.store') }}" role="form" enctype="multipart/form-data">
                            @csrf
                            <!-- Espacio reservado para icono o título si se desea en el futuro -->
