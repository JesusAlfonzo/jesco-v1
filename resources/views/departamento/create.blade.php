...
@section('template_title')
    <i class="bi bi-diagram-3 me-2"></i> Crear Departamento
@endsection
                ...
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-header d-flex justify-content-between align-items-center"
                        ...
                        <span class="card-title float d-flex align-items-center gap-2">
                            <i class="bi bi-diagram-3"></i> Crear Departamento
                        </span>
                        <a href="{{ route('departamentos.index') }}" class="btn btn-outline-light btn-sm d-flex align-items-center rounded-pill px-3">
